...
import { world, ItemStack, ItemLockMode, GameMode, EquipmentSlot, EntityEquippableComponent, ItemDurabilityComponent, ItemEnchantableComponent, } from "@minecraft/server";
import { splitGroups, getRandomRangeValue, getRadiusRange } from "@mcbe-mods/utils";
import setting from "../../System/Setting";
import pickaxe_level from "./PickaxeLevel";
import ore_map from "./Ore_Map";
const isSurvivalPlayer = (dimension, player) => dimension.getPlayers({ gameMode: GameMode.Survival }).some((p) => p.name === player.name);
world.afterEvents.playerBreakBlock.subscribe((e) => __awaiter(void 0, void 0, void 0, function* () {
    if (!setting.getState("enableDigOreOneClick"))
        return;
...
function digOre(player, dimension, location, blockTypeId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!player.isSneaking || !currentSlotItem.hasTag("is_pickaxe"))
                return;
            ...
            const fortune = ((_b = enchantments.getEnchantment("fortune")) === null || _b === void 0 ? void 0 : _b.level) || 0;
...
//# sourceMappingURL=DigOre.js.map