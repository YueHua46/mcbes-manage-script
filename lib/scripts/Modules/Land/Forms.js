    ...
    form.show(player).then((data) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (formValues && formValues[0] && formValues[1] && formValues[2]) {
            ...
            if (validateForm(formValues, player)) {
                ...
                const res = yield land.createLand(landData);
...
export function openLandAuthForm(player, myLand) {
    ...
    form.toggle(color.white("按钮是否公开"), {
        defaultValue: (_a = _myLand.public_auth.useButton) !== null && _a !== void 0 ? _a : false,
        tooltip: "是否允许玩家使用按钮",
    });
...
export function openLandAuthConfigForm(player, _land) {
    ...
    form.toggle(color.white("是否允许成员配置 按钮是否公开"), {
        defaultValue: (_a = _land.config_public_auth.useButton) !== null && _a !== void 0 ? _a : false,
