...
const settingDescriptions: Record<keyof typeof defaultSetting, string> = {
  ...
  landTeleportEnabled: "普通玩家领地传送开关。false 时隐藏相关入口并禁止普通玩家使用，管理员仍可使用。",
