...
export const CARDINAL_DIRECTIONS: readonly CardinalDirection[] = Object.freeze(["north", "east", "south", "west"]);
...
export function offsetRegion(coordinate: RegionCoordinate, direction: CardinalDirection): RegionCoordinate {
  switch (direction) {
    case "north":
      return { rx: coordinate.rx, rz: coordinate.rz - 1 };
    case "east":
      return { rx: coordinate.rx + 1, rz: coordinate.rz };
    case "south":
      return { rx: coordinate.rx, rz: coordinate.rz + 1 };
    case "west":
      return { rx: coordinate.rx - 1, rz: coordinate.rz };
...
export function directionBetween(from: RegionCoordinate, to: RegionCoordinate): CardinalDirection | undefined {
